...
// In this tutorial, I am using the DeepSeek-R1 model hosted on the platform OpenRouter. This model hosted on OpenRouter is available on Langchain's ChatOpenAI class.
...
const createModel = () => {
    return new ChatOpenAI({
      ...
      // modelName: "qwen/qwen3-1.7b:free",
